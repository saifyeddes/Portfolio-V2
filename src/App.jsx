...
import SAIFYEDES from "./assets/images/SAIFYEDES.jpg";
          ...
          <main className="relative z-10 px-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                >
                  <a
                    href="https://github.com/saifyeddes"
                    target="_blank"
                  ...
                  <a
                    href="https://www.instagram.com/saifyeddes/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/in/saif-eddine-yedes/"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  ...
                  <p className="text-white/80 leading-relaxed mt-4 font-cascadia text-justify">
                    ...
                    building modern web applications. Passionate about creating
                    efficient and scalable solutions using the latest
                    technologies. Always eager to learn and grow in the field of
                    software development while delivering high-quality work.
                  </p>
                  ...
                  <div className="flex flex-row sm:flex-row gap-4 mt-8 justify-center md:justify-start items-center">
                    <ButtonMovingBorder
                      as="a"
                      href="https://drive.google.com/file/d/17AF4_nKlqiaD4ENDsrwRtmwDq0dLgrCP/view?usp=sharing"
                      download
                      duration={3000}
            ...
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">
                © {new Date().getFullYear()} Saif Eddine Yedes. All rights
                reserved.
              </div>
